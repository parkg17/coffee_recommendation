<template>
    <div class="back_color">
        <div class="item">
        <h1>선호하는 커피의 특징을 최대 3개까지 선택하세요.</h1>
        </div>

        <div>
            <p class="selectText">기준 1</p>
            <select class="selectBox1" v-model="condition1">
                <option
            ...
            <select class="selectBox2" v-model="condition2">
                <option
                v-for="(item, index) in selectList"
                :key="index"
                :value="item.value"
            ...
            <select class="selectBox3" v-model="condition3">
                <option
                v-for="(item, index) in selectList"
                :key="index"
                :value="item.value"
